                              ...
                              Padding(
                                ...
                                child: Column(
                                  children: [
                                    ...
                                    //     //     _documentID = document.id;
                                    //     //     _compareDate(document['date'].toDate().toString())
                                    //     //         ? DateTime.now().difference(document['date'].toDate()).inMinutes >=0?
                                    //     //     Get.to(()=>CallPage(callID: _documentID!,userId: FirebaseAuth.instance.currentUser!.uid, username: document['name'],))
                                    //     //         : showDialog(context: context, builder: (BuildContext context){
                                    //     //       return AlertDialog(
                                    //     //         content: Column(
                                    //     //           mainAxisSize: MainAxisSize.min,
