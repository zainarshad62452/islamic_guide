...
class MosqueKeeperRegister extends StatefulWidget {
  @override
  _RegisterState createState() => _RegisterState();
}

class _RegisterState extends State<MosqueKeeperRegister> {
  ...
  void _registerAccount() async {
    try{
    Authentication().createAccount(name: _displayName.text, email: _emailController.text, pass: _passwordController.text, isMosqueKeeper: true,contactNo: phone.text,address:city.text,);
    } catch (error) {
      alertSnackbar("$error");
  }
  }
